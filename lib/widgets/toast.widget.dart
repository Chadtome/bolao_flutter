...
//     Color kindColor = Colors.blue;
//     IconData kindIcon = Icons.info_outline;
...
//     // Altura dinâmica com mínimo de 100
//     double toastHeight = 100;
//     if (text.length > 80) toastHeight = 140;

//     final media = MediaQuery.of(context);
//     final topPadding = media.padding.top; // Considera notch
//     final fullWidth = media.size.width;

//     // Cor do texto ajustada ao tema (Dark/Light)
...
//                   // Espaçamento entre barra e conteúdo
//                   const SizedBox(width: 12),

//                   // Conteúdo: ícone, texto, actionLabel e X
//                   Expanded(
//                     child: Row(
