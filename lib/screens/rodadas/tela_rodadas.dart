...
class _TelaRodadasState extends State<TelaRodadas> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          const SizedBox(height: 12),
          // Indicador de permissão (opcional)
          // if (!isAdmin)
          //   Container(
          ...
          //         Text(
          //           'Modo apenas visualização. Apenas administrador pode editar resultados.',
  ...
  //       textAlign: TextAlign.center,
  //       keyboardType: TextInputType.number,
  //       readOnly: !isAdmin, // 👈 Apenas admin pode editar
  //       style: TextStyle(
  //         fontSize: 18, 
  //         fontWeight: FontWeight.bold,
  //         color: !isAdmin ? Colors.grey : null, // Usuário comum vê texto cinza
  //       ),
  //       decoration: InputDecoration(
  //         filled: true,
  //         fillColor: Theme.of(context).colorScheme.surfaceVariant,
