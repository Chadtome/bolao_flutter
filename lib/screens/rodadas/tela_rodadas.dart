            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  height: 300,
                  child: ListView.builder(
                    key: const PageStorageKey('seletor_rodadas'), // 👈 KEY ADICIONADA
                    shrinkWrap: true,
                    itemCount: rodadasMock.length,
                    itemBuilder: (context, index) {
                      final numeroRodada = index + 1;
                      return ListTile(
                        key: ValueKey('rodada_$numeroRodada'), // 👈 KEY ADICIONADA
                        title: Center(
                          child: Text(
                            "Rodada $numeroRodada",
                            style: TextStyle(
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // Primeira linha: setas e título centralizado
          Row(
            key: const Key('header_row'), // 👈 KEY ADICIONADA
            children: [
              IconButton(
                key: const Key('btn_anterior'), // 👈 KEY ADICIONADA
              ...
              IconButton(
                key: const Key('btn_proxima'), // 👈 KEY ADICIONADA
          ...
          Stack(
            ...
            children: [
              ...
              Positioned(
                right: 16,
                child: IconButton(
                  key: const Key('btn_buscar'), // 👈 KEY ADICIONADA
                  onPressed: _abrirSeletorRodadas,
                  icon: const Icon(Icons.search),
                  constraints: const BoxConstraints(minWidth: 40, minHeight: 40),
                ),
          ...
          Expanded(
            child: SingleChildScrollView(
              padding: const EdgeInsets.symmetric(horizontal: 16),
              child: Container(
                key: Key('container_rodada_${rodada.numero}'), // 👈 KEY ADICIONADA
                padding: const EdgeInsets.symmetric(vertical: 8),
                decoration: BoxDecoration(
                    color: Theme.of(context).colorScheme.surface,
                    borderRadius: BorderRadius.circular(12),
                ...
                child: Column(
                  children: rodada.jogos.asMap().entries.map((entry) {
                    ...
                    return Container(
                      key: ValueKey('jogo_${rodada.numero}_$idx'), // 👈 KEY ADICIONADA
                      child: Column(
                        children: [
                          Padding(
                            padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 12),
