...
//                 // Verificar se usuário comum já tem participante
//                 if (usuarioLogado != null && !usuarioLogado.isAdmin && usuarioLogado.participanteId != null) {
//                   AppToast.error(
//                     context: context,
//                     text: 'Você já possui um participante cadastrado. Use a lista para editar se necessário.',
//                   );
//                   return;
//                 }
